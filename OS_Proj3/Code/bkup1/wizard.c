  ...
  while (1)
    {
      ...
      /* Fill in */
	  // ? lock room from being altered, or moved into
	  // ? critical section, stop other wizards and user from taking control 
      ...
      if (other == NULL)
		{
		  ...
		  /* Fill in */
		  // ? sleep/continue to choose new room
      ...
      else
		{
		  ...
		  /* Fill in */
		  // ? Lock room b/c two wizards are in it
		  // ? critical section over, release control to user...
