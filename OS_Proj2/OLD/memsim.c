...
void getEventTraceNumber(FILE * f, int *nTrace);

void vms(int frames, char mode);
void lru(int, char, FILE *);
void clk(int, char, FILE *);
void opt(int, char, FILE *);
...
int totalFrames;		//Total Memory Frames
int eventsInTrace;		//Events in Trace
...
//	getEventTraceNumber(file, &eventsInTrace);
	...
	switch(algo){
		case 'v':
			...
			break;
		case 'l':
			lru(frames, mode, file);
			break;
		case 'c':
			clk(frames, mode, file);
			break;
		case 'o':
...
//****************************************LRU function***************************************
void lru(int frames, char mode, FILE * f)
{
...
//****************************************CLK function***************************************
void clk(int frames, char mode, FILE* f)
{
	Trace pMem[frames];	//Frame table
	Trace page; 		//Page request
	unsigned int addr;	//Address
